...
SECRET_KEY = 'django-insecure-pk+l^4htyie^h1%29d0+vp69p7%n(9ddm0=ce+gjf55&c5h@q9'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Agregar esta línea para especificar la carpeta de plantillas
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
